...
public class SCKVPStoreTest extends BaseTestCase {
  ...
  @Before public void resetDb() throws Exception {
    testContext.deleteDatabase(SCKVPStore.DATABASE_NAME);
  }

  @Test public void testPutIntoKeyValueDB() {
  ...
  @Test public void testGetValueForKey() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    SCKVPStore.put("stores.1234.type", "gpkg");
    Map<String, Object> value = SCKVPStore.getValueForKey("stores.1234.type");
    assertEquals("There should be 1 value returned for the key.", "gpkg",
        value.get("stores.1234.type"));
  }

  @Test public void testGetValuesForKeyPrefix() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    SCKVPStore.put("stores.1234.type", "gpkg");
  ...
  @Test public void testBooleanDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    ...
    assertEquals("The value should be deserialized to a Boolean.", Boolean.FALSE,
        stores.get("stores.1234.isMainBundle"));
  }

  @Test public void testStringDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    SCKVPStore.put("stores.1234.type", "geojson");
    Map<String, Object> stores = SCKVPStore.getValuesForKeyPrefix("stores.1234.type");
    assertEquals("The value should be deserialized to a String.", "geojson",
        stores.get("stores.1234.type"));
  }

  @Test public void testLongDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
  ...
  @Test public void testIntegerDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    ...
    assertEquals("The value should be deserialized to a Long.", Integer.valueOf("100"),
        stores.get("stores.1234.integer"));
  }

  @Test public void testDoubleDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    ...
    assertEquals("The value should be deserialized to a Double.", Double.valueOf("100.001"),
        stores.get("stores.1234.double"));
  }

  @Test public void testFloatDeserialize() {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
    ...
    assertEquals("The value should be deserialized to a Double.", Double.valueOf("100.001"),
        stores.get("stores.1234.float"));
  }

  @Test public void testByteArrayDeserialize() throws IOException {
    SCKVPStore SCKVPStore = new SCKVPStore(testContext);
