...
public class GeoJsonTest extends BaseTestCase {
  ...
  @Test public void testThatDataServiceStartedGeoJsonStore() {
  ...
  @Test public void testSearchGeoJsonStore() {
    ...
    testSubscriber.assertCompleted();
    testSubscriber.assertNoErrors();
    assertEquals("The query should have returned 16 features.", (Integer) 16,
    ...
    assertEquals("The store id should be for the test geojson store.", GEOJSON_STORE_ID,
        feature.getKey().getStoreId());
    assertEquals("The layer should be " + GeoJsonAdapter.DEFAULTLAYER, GeoJsonAdapter.DEFAULTLAYER,
