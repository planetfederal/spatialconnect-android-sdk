...
public class SCBackendServiceTest extends BaseTestCase {
  ...
  @Test public void testNewtworkServiceCanPublishAndSubscribe() {
    ...
    builder.setAction(0).setPayload("testing").setReplyTo(MqttHandler.REPLY_TO_TOPIC).build();
    ...
    assertEquals("The reply message payload should be 'pong'.", "pong",
