...
@Ignore public class SCGpkgTileSourceTest extends BaseTestCase {
  ...
  @Test public void testTileSourcesAreCreatedCorrectly() {
    ...
    assertEquals("The Whitehorse gpkg should have 1 tile source named WhiteHorse.", "WhiteHorse",
        whiteHorseTileSource.getTableName());
    assertEquals("The min zoom level of the WhiteHorse tile source should be 11.", 11,
        (int) whiteHorseTileSource.getMinZoom());
    assertEquals("The max zoom level of the WhiteHorse tile source should be 18.", 18,
        (int) whiteHorseTileSource.getMaxZoom());
    assertEquals("The srs id of the WhiteHorse tile source should be 3857.", 3857,
        (int) whiteHorseTileSource.getSrsId());
    assertEquals("The matrix of the WhiteHorse tile source should have 8 rows.", 8,
