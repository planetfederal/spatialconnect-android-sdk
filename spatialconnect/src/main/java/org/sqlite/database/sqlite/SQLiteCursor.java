...
public class SQLiteCursor extends AbstractWindowedCursor {
   ...
   */
  @Deprecated public SQLiteCursor(SQLiteDatabase db, SQLiteCursorDriver driver, String editTable,
      SQLiteQuery query) {
  ...
  */
  ...
  private void fillWindow(int requiredPos) {
    ...
    try {
      if (mCount == NO_COUNT) {
        ...
        int startPos =
            ExtraUtils.cursorPickFillWindowStartPosition(requiredPos, mCursorWindowCapacity);
  ...
  @Override public void setWindow(CursorWindow window) {
