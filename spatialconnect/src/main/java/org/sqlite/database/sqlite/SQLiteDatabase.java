...
public final class SQLiteDatabase extends SQLiteClosable {
  ...
  private final ThreadLocal<SQLiteSession> mThreadSession = new ThreadLocal<SQLiteSession>() {
    @Override protected SQLiteSession initialValue() {
   ...
   */
  @Deprecated public Map<String, String> getSyncedTables() {
  ...
  public void reopenReadWrite() {
    synchronized (mLock) {
      ...
      mConfigurationLocked.openFlags =
          (mConfigurationLocked.openFlags & ~OPEN_READ_MASK) | OPEN_READWRITE;
      try {
  ...
  public long setMaximumSize(long numBytes) {
    ...
    long newPageCount = ExtraUtils.longForQuery(this, "PRAGMA max_page_count = " + numPages, null);
  ...
  public Cursor query(boolean distinct, String table, String[] columns, String selection,
    ...
    return queryWithFactory(null, distinct, table, columns, selection, selectionArgs, groupBy,
   ...
   * @see Cursor
   */
  public Cursor queryWithFactory(CursorFactory cursorFactory, boolean distinct, String table,
      String[] columns, String selection, String[] selectionArgs, String groupBy, String having,
      String orderBy, String limit) {
    return queryWithFactory(cursorFactory, distinct, table, columns, selection, selectionArgs,
  ...
  public Cursor queryWithFactory(CursorFactory cursorFactory, boolean distinct, String table,
    ...
    try {
      String sql =
          SQLiteQueryBuilder.buildQueryString(distinct, table, columns, selection, groupBy, having,
              orderBy, limit);
    ...
    synchronized (mLock) {
      ...
      if (mHasAttachedDbsLocked) {
        if (Log.isLoggable(TAG, Log.DEBUG)) {
          Log.d(TAG, "this database: "
              + mConfigurationLocked.label
  ...
  private void throwIfNotOpenLocked() {
    if (mConnectionPoolLocked == null) {
      throw new IllegalStateException(
          "The database '" + mConfigurationLocked.label + "' is not open.");
    }
  }
