...
public class SCTileMatrixRow {
    ...
    public SCTileMatrixRow(String tableName, Integer zoomLevel, Integer matrixWidth, Integer matrixHeight,
                           Integer tileWidth, Integer tileHeight, Double pixelXSize, Double pixelYSize) {
