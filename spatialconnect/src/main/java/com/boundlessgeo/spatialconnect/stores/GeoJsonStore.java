...
public class GeoJsonStore extends SCDataStore {
  ...
  @Override public Observable<SCSpatialFeature> queryById(SCKeyTuple keyTuple) {
    return query(null);
  }

  @Override public Observable<Boolean> create(final SCSpatialFeature scSpatialFeature) {
    GeoJsonAdapter geoJsonAdapter = (GeoJsonAdapter) this.getAdapter();
  ...
  @Override public Observable<Boolean> update(final SCSpatialFeature scSpatialFeature) {
    GeoJsonAdapter geoJsonAdapter = (GeoJsonAdapter) this.getAdapter();
  ...
  @Override public Observable<Boolean> delete(final SCKeyTuple keyTuple) {
    GeoJsonAdapter geoJsonAdapter = (GeoJsonAdapter) this.getAdapter();
